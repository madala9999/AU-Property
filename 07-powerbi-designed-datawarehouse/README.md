# Task 9 — Power BI on the Designed Data Warehouse

Rebuilt the Power BI dashboard against the custom star-schema warehouse designed in project 04, integrating the modeled dimensions and facts end-to-end.
